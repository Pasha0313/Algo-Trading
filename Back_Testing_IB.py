from Back_Testing_Base_IB import BackTestingBase_IB
...
class BackTesting_IB(BackTestingBase_IB):
    def __init__(self, ib, contract, timezone,bar_length, start, end=None, tc=0.0, leverage=5, strategy="PV"):
        super().__init__(ib, contract, timezone, bar_length, start, end, tc, leverage, strategy)

    def __repr__(self):
        return "\nIBKR Backtester (symbol = {}, start = {}, end = {})\n".format(self.symbol, self.start, self.end)
